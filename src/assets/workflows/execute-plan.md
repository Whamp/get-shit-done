...
See Checkpoints Reference for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `Context Reference//[your-domain]/api/webhooks/stripe, Events: checkout.session.completed
...
Use Summary Template for structure.
...
For commit message conventions, see Context Reference/step>

...
See Context Reference/source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult Context Reference/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using Context Reference/exclude boundaries
...
6. **Quality check:** Before finalizing findings, consult Context Reference/.claude/get-shit-done/templates/discovery.md
...
Use Context Reference/exclude lists

...
1. Phase Prompt Template
2. Plan Format Reference
3. Scope Estimation Reference
4. Checkpoints Reference
5. TDD Reference
...
See `TDD Reference` for TDD plan structure.
...
See Checkpoints Reference for checkpoint structure.
...
See Scope Estimation Reference for complete guidance.
</step>
...
Use template from `Phase Prompt Template`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `TDD Reference` for TDD plan structure.
</task_quality>
